...
Write-Host 'Download Success, Start Unzip...'
Expand-Archive -Path $rtos_dl_path -DestinationPath $Download_Path
Write-Host 'Unzip Success, you should add this unzip director into CCS project as FREERTOS_INSTALL_DIR when you want to use RTOS'
